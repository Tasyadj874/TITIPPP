    ...
    <div class="red-navbar">
      <nav class="navbar">
        ...
        <div class="navbar-extra">
          <?php if (!$isLoggedIn || $roleLogin !== 'user'): ?>
          ...
          <div class="dropdown" id="login-options">
            ...
            <?php else: ?>
              ...
              <?php if ($roleLogin === 'user'): ?>
                <a href="user/logout.php?redirect=<?php echo urlencode('../index.php'); ?>">Logout</a>
              <?php else: ?>
                <a href="admin/logout.php?redirect=<?php echo urlencode('../index.php'); ?>">Logout</a>
              <?php endif; ?>
            <?php endif; ?>
          </div>
        </div>
    ...
    <div id="form-pemesanan" class="form-popup">
      <div class="form-content">
        ...
        <form id="pemesanan-form">
          <input type="hidden" id="alamat-penerima" name="alamat-penerima" />
          <input type="hidden" id="alamat-toko" name="alamat-toko" />
